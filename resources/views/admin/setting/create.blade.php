    ...
    <div class="card-body">
        ...
        <form action="{{ route('setting.store') }}" method="post" class="row g-3">
            ...
            <div class="col-md-6">
                ...
                <input type="text" name="nama_kantor" class="form-control" placeholder="Masukkan nama kantor">
            </div>
            <div class="col-md-6">
            ...
            <div class="col-md-6">
                ...
                <input type="number" name="radius_meter" class="form-control" placeholder="Contoh: 100">
            </div>
